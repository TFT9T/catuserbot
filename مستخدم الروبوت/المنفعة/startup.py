    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await catub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/8dee609d275d9e650b3ee.jpg",
                caption="**ارحب بالبطل تم تشغيل بوتك بنجاح تتهنى بسورس العرب**",
                buttons=[(Button.url("قروب السورس", "https://t.me/tft0t"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
